...
// Check token
export const checkTokenRequest = createAction('[Auth] Check Token Request');
export const checkTokenSuccess = createAction('[Auth] Check Token Success');
export const checkTokenFailure = createAction('[Auth] Check Token Failure');
