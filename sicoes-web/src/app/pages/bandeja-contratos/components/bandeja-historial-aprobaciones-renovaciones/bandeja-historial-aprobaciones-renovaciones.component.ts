...
@Component({
  ...
  templateUrl: './bandeja-historial-aprobaciones-renovaciones.component.html',
})
export class BandejaHistorialAprobacionesRenovacionesComponent extends BasePageComponent<any> implements OnInit {
