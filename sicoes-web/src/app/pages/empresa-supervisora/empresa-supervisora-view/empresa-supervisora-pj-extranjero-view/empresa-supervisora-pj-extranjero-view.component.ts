...
@Component({
  selector: 'vex-empresa-supervisora-pj-extranjero-view',
  templateUrl: './empresa-supervisora-pj-extranjero-view.component.html',
  styleUrls: ['./empresa-supervisora-pj-extranjero-view.component.scss']
})
export class EmpresaSupervisoraPjExtranjeroViewComponent extends BaseComponent implements OnInit {
