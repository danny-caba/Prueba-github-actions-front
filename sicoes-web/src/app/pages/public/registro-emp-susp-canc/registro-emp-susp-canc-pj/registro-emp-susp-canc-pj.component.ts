...
@Component({
  selector: 'vex-registro-emp-susp-canc-pj',
  templateUrl: './registro-emp-susp-canc-pj.component.html',
  styleUrls: ['./registro-emp-susp-canc-pj.component.scss'],
  animations: [
    fadeInUp400ms,
    stagger80ms
  ],
...
export class RegistroEmpSuspCancPjComponent extends BasePageComponent<Solicitud> implements OnInit {
  ...
  displayedColumns: string[] = [
    "pais", "tipoDocumento", "numeroDocumento", "razonSocial", "estado", "inicio", "fin"
  ];
