...
@Component({
  selector: 'vex-registro-emp-susp-canc-pn',
  templateUrl: './registro-emp-susp-canc-pn.component.html',
  styleUrls: ['./registro-emp-susp-canc-pn.component.scss'],
  animations: [
    fadeInUp400ms,
    stagger80ms
  ],
...
export class RegistroEmpSuspCancPnComponent extends BasePageComponent<Solicitud> implements OnInit {
