...
import { RequerimientoRenovacionRoutingModule } from './requerimiento-renovacion-routing.module';
...
@NgModule({
  ...
  imports: [
    CommonModule,
    RequerimientoRenovacionRoutingModule,
    CommonModule,
    MatRadioModule,
    FormsModule,
    ReactiveFormsModule,
...
export class RequerimientoRenovacionModule { }
