...
@Component({
  selector: 'vex-solicitud-pn-postor-form',
  templateUrl: './solicitud-pn-postor-form.component.html',
  styleUrls: ['./solicitud-pn-postor-form.component.scss'],
  animations: [
    fadeInUp400ms,
    stagger80ms
  ]
})
export class SolicitudPnPostorFormComponent extends BaseComponent implements OnInit, OnDestroy {
      ...
      if (result.isConfirmed) {
        let formValues = {
          persona: {
            ...
            tipoPersona: {
              codigo: TipoPersonaEnum.PN_POSTOR
            }
          },
