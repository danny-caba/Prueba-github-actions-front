...
@Component({
  selector: 'vex-solicitud-pj-extranjero-edit',
  templateUrl: './solicitud-pj-extranjero-edit.component.html',
  styleUrls: ['./solicitud-pj-extranjero-edit.component.scss'],
  animations: [
    fadeInUp400ms,
    stagger80ms
  ]
})
export class SolicitudPjExtranjeroEditComponent extends BaseComponent implements OnInit, OnDestroy {
  ...
  @ViewChild('layoutDatosPersJur', { static: true }) layoutDatosPersJur: LayoutDatosPersJurExntrajeroComponent;
