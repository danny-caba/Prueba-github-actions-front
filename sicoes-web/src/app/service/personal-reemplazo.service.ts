...
export class PersonalReemplazoService {
  ...
  guardarBajaPersonal(
    personalBaja: Partial<PersonalReemplazo>
  ): Observable<any> {
  ...
  adjuntarArchivo(formData: any): Observable<any> {
    return this.http.post<any>(
      `${this._path_serve}/api/documentosreemplazo`,
      formData,
      {
        reportProgress: true,
        observe: "events",
  ...
  obtenerSeccionAdenda(idReemplazo: number | string, seccion: string): Observable<any> {
