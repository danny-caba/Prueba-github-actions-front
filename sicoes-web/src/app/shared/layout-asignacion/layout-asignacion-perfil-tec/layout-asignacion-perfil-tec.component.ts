...
@Component({
  selector: 'vex-layout-asignacion-perfil-tec',
  templateUrl: './layout-asignacion-perfil-tec.component.html',
  styleUrls: ['./layout-asignacion-perfil-tec.component.scss']
})
export class LayoutAsignacionPerfilTecComponent extends BaseComponent implements OnInit, OnDestroy, OnChanges {
  ...
  evaluadorExiste(evaluador: any) {
    if (this.listEvaluadoresAdminis.find(listRes => listRes == evaluador)  || this.listarEvaladoresAsignados.find(listRes => listRes?.nombreUsuario == evaluador.nombreUsuario)) {
