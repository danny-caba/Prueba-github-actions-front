...
@Component({
  selector: 'vex-layout-datos-pers-jur',
  templateUrl: './layout-datos-pers-jur.component.html',
  styleUrls: ['./layout-datos-pers-jur.component.scss'],
  animations: [
    fadeInUp400ms
  ]
})
export class LayoutDatosPersJurComponent extends BaseComponent implements OnInit {
  ...
  formGroup = this.fb.group({
    ...
    codigoProvincia: [''],
    codigoDistrito: [''],
    codigoPartidaRegistral: ['', Validators.required],
