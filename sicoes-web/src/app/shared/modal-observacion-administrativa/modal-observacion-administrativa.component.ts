...
@Component({
  selector: 'vex-modal-observacion-administrativa',
  templateUrl: './modal-observacion-administrativa.component.html',
  styleUrls: ['./modal-observacion-administrativa.component.scss'],
  animations: [
    fadeInUp400ms,
    stagger80ms
  ]
})
export class ModalObservacionAdministrativaComponent extends BaseComponent implements OnInit, OnDestroy {
  ...
  constructor(
    private dialogRef: MatDialogRef<ModalObservacionAdministrativaComponent>,
