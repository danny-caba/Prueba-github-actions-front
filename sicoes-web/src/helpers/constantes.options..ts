...
export enum Opcion {
    ...
    CHECKBOX_INFORME = 'CHECKBOX_INFORME',
    CHECKBOX_PERS_PROPUESTO = 'CHECKBOX_PERS_PROPUESTO',
    CHECKBOX_SOL_REEMPLAZO = 'CHECKBOX_SOL_REEMPLAZO',
    CHECKBOX_PROY_ADENDA = 'CHECKBOX_PROY_ADENDA',
...
export const OpcionPorRol = [{
  ...
  opciones: [
    ...
    Opcion.CHECKBOX_PERS_PROPUESTO,
    Opcion.CHECKBOX_SOL_REEMPLAZO
  ]
},{
